...
export const ParticipantForm = ({ participant, onSuccess, onCancel }: ParticipantFormProps) => {
  const { t } = useTranslation();
  const queryClient = useQueryClient();
  const isEditing = !!participant;

  // Form state
  const [formData, setFormData] = useState<Omit<Participant, "id" | "assignedQuestions">>({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* Country */}
        <div className="space-y-2">
          <Label htmlFor="country">{t("admin.participants.form.country")}</Label>
          <Input
            id="country"
            name="country"
        ...
        {/* Category */}
        <div className="space-y-2">
          <Label htmlFor="category">{t("admin.participants.form.category")}</Label>
          <Input
            id="category"
            name="category"
        ...
        {/* Parent's Name */}
        <div className="space-y-2">
          <Label htmlFor="parentsName">{t("admin.participants.form.parentsName")}</Label>
          <Input
            id="parentsName"
            name="parentsName"
        ...
        {/* Phone Number */}
        <div className="space-y-2">
          <Label htmlFor="phoneNum">{t("admin.participants.form.phoneNum")}</Label>
          <Input
            id="phoneNum"
            name="phoneNum"
