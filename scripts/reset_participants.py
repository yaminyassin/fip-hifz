...
def reset_participants_collection():
    """Main function to reset the participants collection."""
    ...
    try:
        ...
        logging.error(f"Error resetting participants collection: {e}")
        sys.exit(1)

if __name__ == "__main__":
    logging.info("Starting participants collection reset script...")
    logging.info("This script will DELETE ALL DOCUMENTS from the 'participants' collection.")
    
    # Ask for confirmation
    response = input("Are you sure you want to delete ALL participants? This action cannot be undone. (y/N): ")
    ...
    reset_participants_collection()
    logging.info("Participants collection reset completed.") 